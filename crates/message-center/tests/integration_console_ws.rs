...
//! Integration test: `/ws/console` live-pushes message-center events.
...
async fn console_ws_pushes_events() {
    ...
    // The console bus is process-wide per message-center. We need a way to
    // share it between the test and the message-center’s WS handler. For

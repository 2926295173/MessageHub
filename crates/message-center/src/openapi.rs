...
#[openapi(
    info(
        ...
        version = "0.1.0",
        description = "REST API for the PhoneBridge desktop message-center. All endpoints live under /api/v1.",
    ...
    tags(
        ...
        (name = "identity", description = "This message-center's cert + identity"),

//! Daemon's long-term identity: device id, ECDH keypair, cert, fingerprint.
...
/// Load or create the daemon identity, persisting it under `{data_dir}`.
